    ...
    def get_action(self):
        ...
        if vr_events != ():
            ...
            for event in vr_events:
                ...
                # print(p.VR_BUTTON_IS_DOWN, event[self.BUTTONS][self.BUTTON_DEADMAN])
                if not self._dead_mans_switch_down(event):
                    if self.prev_action is not None:
                        self.prev_action["deadman_pressed"] = False
                ...
                robot_action = {"controller_pos_bf": controller_pos_bf, 
                                ...
                                "deadman_pressed": event[self.BUTTONS][self.BUTTON_DEADMAN],
                                "ref": "abs"}
